...
'' ustring (var-len UTF-16). See src/rtlib/fb_ustring.h.
#define FB_RTL_USTRINIT                 "fb_UStrInit"
#define FB_RTL_USTRDELETE               "fb_UStrDelete"
#define FB_RTL_HUSTRDELTEMP             "fb_hUStrDelTemp"
#define FB_RTL_USTRASSIGN               "fb_UStrAssign"
#define FB_RTL_USTRCONCAT               "fb_UStrConcat"
...
#define FB_RTL_PRINTUSGUSTR             "fb_PrintUsingUStr"
...
enum FB_RTL_IDX
	...
	'' ustring
	FB_RTL_IDX_USTRINIT
	FB_RTL_IDX_USTRDELETE
	FB_RTL_IDX_HUSTRDELTEMP
	FB_RTL_IDX_USTRASSIGN
	FB_RTL_IDX_USTRCONCAT
...
'' ustring (rtl-ustring.bas)
declare function rtlUStrAssign _
	( _
		byval dst as ASTNODE ptr, _
		byval src as ASTNODE ptr, _
		byval is_init as integer = FALSE _
	) as ASTNODE ptr

declare function rtlUStrConcat _
	( _
		byval str1 as ASTNODE ptr, _
		byval sdtype1 as integer, _
		byval str2 as ASTNODE ptr, _
...
declare function rtlUStrConcatAssign _
	( _
		byval dst as ASTNODE ptr, _
		byval src as ASTNODE ptr _
	) as ASTNODE ptr
...
declare function rtlUStrCompare _
	( _
		byval str1 as ASTNODE ptr, _
		byval sdtype1 as integer, _
		byval str2 as ASTNODE ptr, _

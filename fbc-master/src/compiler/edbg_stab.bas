...
'' globals
	...
	{ _
		...
		14, _                                   '' fix-len string
		17, _                                   '' va_list
		 0, _                                   '' struct    ) these six were implicit 0
		 0, _                                   '' namespc   ) before ustring extended
		 0, _                                   '' function  ) this table; spelled out
		 0, _                                   '' fwdref    ) now so the new entries
		 0, _                                   '' pointer   ) line up verifiably
		 0, _                                   '' xmmword   )
		19, _                                   '' ustring
		21  _                                   '' fix-len ustring
	}
	...
	{ _
		...
		@"va_list:t17=-11", _
		@"wchar:t18=-30", _
		@"ustring:t19=s12data:20,0,32;len:1,32,32;size:1,64,32;;", _
		@"pushort:t20=*6;", _  '' used for the data ptr in the ustring:t19 declaration only
		@"fixustr:t21=-7" _    '' -7 = unsigned short: a code unit is always 16 bits
	}
